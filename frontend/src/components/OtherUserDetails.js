          ...
          references: [
            {
              ...
              refProfileUrl: "www.linkedin.com/jessica.carleton"
            },
            {
              refProvider: "Git",
              refProfileUrl: "www.github.com/jcarleton"
            }
          ]
    };
  }
            ...
            {this.state.courses.map((course,i)=>{
              return (
                <div className="ui segment grid">
                  ...
                  <div className="ui three wide column"><Button basic color="blue">Join</Button></div>          {/* cond: only groups in current semester can be joined  */}
